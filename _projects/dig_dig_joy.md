...
header: '/assets/images/projects/ddj/header.png'
thumbnail: '/assets/images/projects/ddj/01.gif'
images: ['/assets/images/projects/ddj/01.gif',
        '/assets/images/projects/ddj/02.gif',
